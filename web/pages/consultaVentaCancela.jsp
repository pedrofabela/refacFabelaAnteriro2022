...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
     ...
     function consultaCliente(accion, valor, valor2) {
         ...
         function borrarProducto(accion, valor, valor2) {
             
            document.forma.NO_PARTE.value = valor;
            document.forma.NO_PRODUCTOVENTA.value = valor2;
            document.forma.action = accion;
            document.forma.target = "_self";
            document.forma.submit();
        }
                    ...
                    <s:hidden name="usuariocons.NAMEUSUARIO" id="%{usuariocons.NAMEUSUARIO}"></s:hidden> 
                        ...
                        <article class="articulo1" >
                            ...
                            <s:textfield name="camp.NO_VENTA" id="camp.NO_VENTA" placeholder="Número de Venta" required="true"  cssClass="campoFormBusqueda" onKeyUp="this.value=this.value.toUpperCase();"/>
                              ...
                              <a href="Javascript:guarda('consultaVentaCancela')"><div class="boton">  Buscar cancela  </div> </a>
                                            ...
                                            <s:iterator value="ListaCarroCotizacion" id="  ListaCarroCotizacion" status="stat" >
                                              <tr>
                                                ...
                                                <td id="centrar-dato" style="background: green; color:white;"><s:property value="PRECIO_FINAL" /></td>
                                                 <td  id="centrar-dato">  <div class="img-pos-eliact" ><a href="Javascript:borrarProducto('borrarProductoVenta','<s:property value="NO_PARTE" />','<s:property value="NO_PRODUCTOVENTA" />')" style="margin: auto;"><img src="img/iconEliminar.png" alt="Eliminar"></img></a></div></td>
...
<s:textfield type="text" name="camp.NO_PRODUCTOVENTA" id="NO_PRODUCTOVENTA" style='visibility:hidden'   ></s:textfield>
